...
def _compile(
    ...
    if _is_enabled(
        ...
        if _is_enabled(
            ...
            derived_args.add("-enable-library-evolution")
            ...
            if _is_enabled(
                ...
                derived_args.add("-emit-module-interface-path")
                derived_args.add(swiftinterface)
                additional_derived_outputs.append(swiftinterface)
